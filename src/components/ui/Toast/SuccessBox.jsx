...
const SuccessBox = () => {
	...
	return (
		<Transition show={success.showSuccessBox}>
			...
			>
				<div
					className="fixed bottom-0 right-0 z-[60] xl:w-4/12 lg:w-5/12 md:w-8/12 sm:w-3/4 w-11/12 px-5 py-4 border-2 border-success-500 backdrop-brightness-200 bg-success-500 bg-opacity-50 backdrop-blur-[24px] rounded-lg shadow-2xl -translate-x-4 -translate-y-4 break-words"
					role="alert"
				>
