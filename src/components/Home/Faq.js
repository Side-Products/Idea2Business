		...
		return (
			...
			>
				...
				<h2 className="mb-0" id={elem.content_heading}>
					<button
						type="button"
						className="group relative flex w-full items-center rounded-t-[15px] bg-dark-800 py-4 px-5 text-left text-xl font-medium text-light-400 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none [&:not([data-te-collapse-collapsed])]:bg-white [&:not([data-te-collapse-collapsed])]:text-primary-400 [&:not([data-te-collapse-collapsed])]:[box-shadow:inset_0_-1px_0_rgba(229,231,235)] dark:[&:not([data-te-collapse-collapsed])]:bg-dark-800 dark:[&:not([data-te-collapse-collapsed])]:[box-shadow:inset_0_-1px_0_rgba(75,85,99)]"
						onClick={() => {
				...
				>
					<div class="py-4 px-5">{elem.body}</div>
				</div>
			</div>
		);
	});
