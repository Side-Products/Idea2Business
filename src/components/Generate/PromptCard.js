...
export default function PromptCard({
	...
	// Radial gradient effect on prompt card
	useEffect(() => {
		const constrain = 80;
	...
	return (
		<form
			className={
				...
				// " bg-gradient-to-r from-[#161616] to-[#202020] shadow hover:shadow-primary-400" +
		...
		>
			...
			{cardsAvailable && canAccess ? (
				<div className="absolute bottom-3 flex space-x-2 px-4 py-1 justify-center items-center">
					<Button type="submit" variant={"primary"} rounded={true} classes="bg-gray-600 text-xs px-4 py-1 gap-x-1">
